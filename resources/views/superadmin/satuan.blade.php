...
<div class="flex mb-2">
  ...
  <span class="bg-green-400 h-10 w-10 ml-10 rounded-full  transition">
    <a href="/administrator/satuan/add">
  ...
  <table class="w-full h-2 table table-zebra table-compact">
      <thead class=" text-black">
          <tr class="sticky top-0">    
              ...
              <th class="w-10 border text-center whitespace-nowrap">@sortablelink('satuan','Satuan')</th>
              ...
              <td class=" border  text-center whitespace-nowrap">
                <div class="flex">    
                  ...
                  <span class="bg-red-500 h-10 w-10  px-auto mx-auto rounded-full">
                    <form action="/administrator/satuan/delete" method="POST">
                      @csrf
                      <input type="hidden" name="id" value="{{ $satuan->id }}">
                      <button type="submit">
